...
<!-- 機能提案では、機能要件、非機能要件、代替案などを記載してくださると助かります-->
<!-- Please provide any supplementary information for this issue's description or purpose. -->
<!-- For feature requests, it is helpful if you can provide functional requirements, non-functional requirements, alternative ideas, etc. -->
